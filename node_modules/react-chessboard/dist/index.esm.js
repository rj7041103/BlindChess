...
function Piece({ isPremovedPiece = false, piece, square, squares, }) {
    ...
    return (jsx("div", Object.assign({ ref: arePiecesDraggable ? (canDrag ? drag : null) : null, onClick: () => onPieceClick(piece, square), "data-piece": piece, style: pieceStyle }, { children: typeof chessPieces[piece] === "function" ? (chessPieces[piece]({
...
const Chessboard = forwardRef((props, ref) => {
    ...
    return backendSet && clientWindow ? (jsx(ErrorBoundary, { children: jsxs("div", Object.assign({ ref: boardContainerRef, style: {
                display: "flex",
                flexDirection: "column",
                width: "100%",
            } }, { children: [jsx("div", { ref: boardRef, style: { width: "100%" } }), jsx(DndProvider, Object.assign({ backend: backend, context: clientWindow, options: customDndBackend ? customDndBackendOptions : undefined }, { children: boardWidth && (jsxs(ChessboardProvider, Object.assign({ boardWidth: boardWidth }, otherProps, { ref: ref }, { children: [jsx(CustomDragLayer, { boardContainer: boardContainerPos }), jsx(Board, {})] }))) }))] })) })) : null;
});
