...
}, onPromotionPieceSelect, onSquareClick = () => { }, onSquareRightClick = () => { }, position = "start", promotionDialogVariant = "default", promotionToSquare = null, showBoardNotation = true, showPromotionDialog = false, snapToCursor = true, }, ref) => {
...
function Piece({ isPremovedPiece = false, piece, square, squares, }) {
    ...
    return (jsxRuntime.jsx("div", Object.assign({ ref: arePiecesDraggable ? (canDrag ? drag : null) : null, onClick: () => onPieceClick(piece, square), "data-piece": piece, style: pieceStyle }, { children: typeof chessPieces[piece] === "function" ? (chessPieces[piece]({
...
const Chessboard = react.forwardRef((props, ref) => {
    ...
    return backendSet && clientWindow ? (jsxRuntime.jsx(ErrorBoundary, { children: jsxRuntime.jsxs("div", Object.assign({ ref: boardContainerRef, style: {
                display: "flex",
                flexDirection: "column",
                width: "100%",
            } }, { children: [jsxRuntime.jsx("div", { ref: boardRef, style: { width: "100%" } }), jsxRuntime.jsx(DndProvider, Object.assign({ backend: backend, context: clientWindow, options: customDndBackend ? customDndBackendOptions : undefined }, { children: boardWidth && (jsxRuntime.jsxs(ChessboardProvider, Object.assign({ boardWidth: boardWidth }, otherProps, { ref: ref }, { children: [jsxRuntime.jsx(CustomDragLayer, { boardContainer: boardContainerPos }), jsxRuntime.jsx(Board, {})] }))) }))] })) })) : null;
});
